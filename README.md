...
For an example of report generated from the R Notebook, see [example.nb.html](http://htmlpreview.github.io/?https://github.com/chuvpne/dada2/blob/master/example.nb.html).
